...
export const COMBO_FORMULAS: ComboFormula[] = [
  {
    ...
    result: {
      ...
      effect: { power: 10, mythDensity: 10 },
  ...
  },
  {
    ...
    result: {
      ...
      effect: { supply: 15, tyranny: 10, mythDensity: 10 },
  ...
  },
  {
    ...
    result: {
      id: 'myth_leviathan',
      name: '利维坦的觉醒',
      description: '终极合成：一个自我维持的政治神话体。',
      effect: { mythDensity: 30, power: 15, supply: 10, sanity: -30 },
      source_combo: [
        'card_plastic_guan_yu',
        'card_red_phone',
        'card_half_history',
